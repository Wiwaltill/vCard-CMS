...
function admin_t(string $key, ?array $config = null): string
{
    static $dict = [
        ...
        'en' => [
            ...
            'datatypes_saved'=>'Data types saved.','vcard_fields_note'=>'Note about vCard fields:','vcard_fields_help'=>'More information about possible vCard fields and their meaning is available on','sort_and_show_datatypes'=>'Sort and display data types','order'=>'Order','label'=>'Label','type'=>'Type','show'=>'Show','vcard_field_optional'=>'vCard field optional','system_field'=>'System field','drag_help'=>'The order can be changed by drag & drop. System fields cannot be deleted, but can be hidden.','add_datatype'=>'Add new data type','add_datatype_button'=>'Add data type','social_platform'=>'Social media platform','please_choose'=>'Please choose','social_auto_help'=>'For social media, label, key and vCard field are set automatically, e.g.','social_username_help'=>'For social media, the username is enough in the contact form later. Example:',
